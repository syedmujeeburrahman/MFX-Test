...
class DearerpDemoItem(models.Model):
    ...
    section_type = fields.Selection(related='section_id.section_type',
                                     string='Section Type', store=True)
    ...
    content = fields.Html(string='Detailed Content', sanitize_style=True,
